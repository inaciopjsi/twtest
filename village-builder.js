            ...
            <div class="${mainClass} ra-box-widget" id="${id}">
                ...
                <div class="${mainClass}-footer">
                    <small>
                        ...
                        <a href="${this.scriptData.helpLink
            }" target="_blank" rel="noreferrer noopener">
                            ${this.tt('Help')}
                        </a>
                    </small>
...
const CONFIG = {
    intervalMinutes: 2,
    maxQueueSize: 5,
    farmPriorityPercent: 95,
    storagePriorityPercent: 90,
...
function getResources() {
    return {
        wood: parseInt(game_data.village.wood || 0, 10),
        stone: parseInt(game_data.village.stone || 0, 10),
        iron: parseInt(game_data.village.iron || 0, 10),
        storage: parseInt(game_data.village.storage_max || 1, 10),
        pop: parseInt(game_data.village.pop || 0, 10),
        popMax: parseInt(game_data.village.pop_max || 1, 10),
    };
}
...
function importProfiles() {
    const json = prompt('Cole o JSON dos perfis:');
    if (!json) return;
    try {
